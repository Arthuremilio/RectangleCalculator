...
begin
  try
    try
      ...
      on  E: Exception do
          ShowMessage(format('Ocorrreu um erro ao calcular o Perimetro e a Área do retangulo : %s',[E.Message]));
    end;
  finally
...
procedure TfrmCalculadoraRetangulo.exibirResultado(const Perimetro,
  Area: Double);
begin
    lblPerimetro.Caption := 'O perimetro do retângulo é: ' + FloatToStr(Perimetro);
    lblArea.Caption := ' A Área do retângulo é: ' + FloatToStr(Area);
end;
